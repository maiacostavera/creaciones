...
window.PRODUCTOS = [
  ...
  },
  {
    ...
    descripcion: "Con nombre, frase, foto o el diseño que quieras.",
    detalle:
      "Taza de cerámica personalizada con lo que se te ocurra: un nombre, una frase, una foto o un dibujo. Ideal para regalar. Consultame por los modelos y colores disponibles.",
    imagen: "assets/img/productos/taza-personalizada.svg",
    imagenes: [],
    destacado: true,
    disponible: true,
    etiquetas: ["taza", "personalizada", "regalo", "foto", "frase", "ceramica"],
  },
  {
